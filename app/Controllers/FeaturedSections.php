...
class FeaturedSections extends Controller
{
        ...
        if (!$this->session->get('isLoggedIn')) {
            ...
            if ($this->request->getVar('language_id')) {
                ...
                if ($this->request->getVar('news_type') == 'news') {
                    $results = $this->db->table('tbl_news')->where('language_id', $language_id)->get()->getResult();
    ...
    public function store()
    {
        if (is_modification_allowed()) {
            ...
            $data = [
                'language_id'       => $this->request->getVar('language_id'),
                'title'             => $this->request->getVar('style_app')  == 'style_6' ? "Not Applicable"  : $this->request->getVar('title'),
                'short_description' => $this->request->getVar('style_app')  == 'style_6' ? "Not Applicable" : $this->request->getVar('short_description'),
