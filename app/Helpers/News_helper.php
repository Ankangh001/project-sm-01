...
if (!function_exists('style_app')) {
    function style_app($style_app)
    {
        ...
        } elseif ($style_app == 'style_6') {
            $image = '<a href="' . APP_URL . 'public/images/app_style/App_Style_6.png"  data-toggle="lightbox" data-title="Image"><img src="' . APP_URL . 'public/images/app_style/App_Style_6.png" alt="style_6" class="" height=50, width=50></a>';
        }
        return $image;
    }
}
...
if (!function_exists('style_web')) {
    function style_web($style_web)
    {
        ...
        } elseif ($style_web == 'style_6') {
            $image = '<a href="' . APP_URL . 'public/images/app_style/Web_Style_6.png"  data-toggle="lightbox" data-title="Image"><img src="' . APP_URL . 'public/images/app_style/Web_Style_6.png" alt="style_6" class="" height=40, width=100></a>';
        }
        return $image;
    }
}
