...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-6 row">
                                                    ...
                                                    <!-- For style_6: title & description are not applicable so in database, both values are not added-->
                                                    <div class="col-md-2 col-sm-2">
                                                ...
                                                <div class="col-md-6 row" style="display:none;">
                                                    ...
                                                    <div class="col-md-2 col-sm-2">
                                                        <label class="radio-img-web">
                                                            ...
                                                            <img src="<?= APP_URL ?>public/images/app_style/Web_Style_6.png"
                                                                alt="style_6" class="style_image">
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6 row">
                                        ...
                                        <div class="col-md-2">
                                            <label class="radio-img edit-radio-img">
                                                ...
                                                <img src="<?= APP_URL ?>public/images/app_style/App_Style_6.png"
                                                    alt="style_6" class="style_image">
                                            </label>
                                        </div>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            $("input[name='style_app']").on("change", function() {
                // Get the value of the "style_app" input
                var styleAppValue = $(this).val();

                // Find the "title" input element with class "title-input"
                var titleInput = $("input[name='title']");
                var descriptionInput = $("input[name='short_description']");

                // Disable the "title" input if "style_app" is equal to a specific value (e.g., "style_disabled")
                if (styleAppValue === "style_6") {
