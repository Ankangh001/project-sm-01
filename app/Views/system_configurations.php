                            ...
                            <div class="card card-secondary">
                                ...
                                <form action="<?= base_url(); ?>/store_system_setting" role="form" id="insert_form" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Auto News Deletion -->
                                        <div class="form-group row">
                                            <h5 class="text-bold">News Setting</h5>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2 col-sm-6">
                                                <label>Enable Location in News</label>
                                                <div>
                                                    <input type="checkbox" id="location_news" name="location_news" <?php
                                                    if ($location_news_mode) {
                                                        echo ($location_news_mode[0]->message == '1') ? 'checked' : '';
                                                    }
                                                    ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                                    <input type="hidden" id="location_news_mode" name="location_news_mode" value="<?=($location_news_mode) ? $location_news_mode[0]->message : 0; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-sm-6 nearestLocationMeasureHide">
                                                <label>Nearest Location Measure(in KM)</label>
                                                <div>
                                                <input type="number" name="nearest_location_measure" value="<?=($nearest_location_measure) ? $nearest_location_measure[0]->message : '' ?>" class="form-control" placeholder="Nearest Location Measure(in KM)" required />
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <hr>
                                        <div class="form-group row">
                                            <h5 class="text-bold">Job Add Settings <small>(add hyperlink for specific category)</small></h5>
                                    </div>
                                    <div class="form-group row">
                                            <div class="col-sm-4">
                                                <label>HTML Code</label>
                                                <input type="text" name="job_add_link" value="<?=($job_add_link) ? $job_add_link[0]->message : '' ?>" class="form-control" placeholder="<a href=''>somehere</a>" required />
                                            </div>
                                            <div class="col-sm-4">
                                                <label>Comma Separated Category ID</label>
                                                <input type="text" name="job_add_category" value="<?=($job_add_category) ? $job_add_category[0]->message : '' ?>" class="form-control" placeholder="3,1" required />
                                            </div>
                                    </div>  
