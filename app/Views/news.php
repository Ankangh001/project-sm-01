                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <select name="location_id" class="form-control select select_location_id" id="select_location_id" required>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php if (is_category_enabled() == 1) { ?>
                                            <div class="row">
                                                ...
                                                <?php if (is_location_news_enabled() == 1) { ?>
                                                <div class="col-sm-3 col-md-3 col-lg-1">
                                                    <select id="filter_location" name="location" class="form-control" required>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <?php if (is_location_news_enabled() == 1) { ?>
                                        <div class="col-md-4">
                                        <label>Tag</label>
                                        <select id="tag_id2" name="tag_id[]" class="form-control select2 select_tag_id edit_select_tag_id"
                                            multiple="multiple">
                                            <?php foreach ($tag as $tag1): ?>
                                                <option value="<?= $tag1['id']; ?>">
                                                    <?= $tag1['tag_name']; ?>
                                            ...
                                            <?php endforeach; ?>
                                                ...
                                                <div class="col-sm-2">
                                                    <label>Location</label>
                                                    <select id="edit_location" name="location_id" class="form-control" id="select_location_id">
                                                        <?php foreach ($location as $location1): ?>
                                                            <option value="<?= $location1['id']; ?>">
                                                                <?= $location1['location_name']; ?>
                                                            </option>
        ...
        <script type="text/javascript">
            window.actionEvents = {
                'click .edit-data': function (e, value, row, index) {
                    ...
                    $("#edit_location").val(row.location_id);
                    <?php if (is_category_enabled() == 1) { ?>
